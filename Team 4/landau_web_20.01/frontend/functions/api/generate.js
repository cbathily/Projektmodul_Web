 ...
 * - N8N_WEBHOOK_PATH: The webhook path (e.g., /webhook/xxx-xxx-xxx)
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const n8nWebhookPath = env.N8N_WEBHOOK_PATH;
    ...
    console.log('Proxying request to n8n...'); // Only visible in Cloudflare logs
